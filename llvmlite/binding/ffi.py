...
LLVMNamedMDNodeRef = _make_opaque_ref("LLVMNamedMDNode")
...
LLVMAliasIteratorRef = _make_opaque_ref("LLVMGlobalsAliasIterator")
LLVMFunctionsIterator = _make_opaque_ref("LLVMFunctionsIterator")
LLVMBlocksIterator = _make_opaque_ref("LLVMBlocksIterator")
LLVMPredBlocksIterator = _make_opaque_ref("LLVMPredBlocksIterator")
...
LLVMNamedMetaIterator = _make_opaque_ref("LLVMNamedMetaIterator")
